...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      className="sticky bottom-0 z-30 shrink-0 border-t border-line bg-[color:var(--surface)]/95 px-2 pb-[max(0.55rem,env(safe-area-inset-bottom))] pt-2 backdrop-blur-md"
    >
